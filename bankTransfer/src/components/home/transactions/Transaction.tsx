...
import { CreateTransactionForm } from "../forms/createTransaction/CreateTransactionForm";
import { FindTransactionForm } from "../forms/findTransaction/FindTransactionForm";
    ...
    return (
        <section>
            <div className="transaction-operation flex gap-8 justify-evenly mt-8 mb-12">
                <ViewTransaction />
                <div className="form-transaction-grid h-full w-5/12 grid">
